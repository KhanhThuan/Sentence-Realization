...
public class Main {
	public static void main(String[] args) throws Exception{
		...
		/******************INPUT*******************************/
			...
			String intputFile ="examples/bag-of-word-type-input/test_4.txt" ; // "examples/tree-type-input/test_0.DEP"
			String refFile = "examples/bag-of-word-type-input/ref_4.txt" ; //  // "examples/tree-type-input/ref_0.txt"
